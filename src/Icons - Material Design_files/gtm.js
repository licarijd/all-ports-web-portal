...
"resource": {
  ...
  "rules":[
    ...
    [["if",2],["add",1]],
    [["if",3],["add",1,15,9,10,11,12,13,14]],
...
var hc={},ic=null;hc.o="GTM-NHRPF8";var jc=null,kc="//www.googletagmanager.com/a?id="+hc.o+"&cv=12",lc={},mc={},nc=G.currentScript?G.currentScript.src:void 0;var oc=function(){},pc=function(a){return"function"==typeof a},qc=function(a){return"string"==sa(a)},rc=function(a){return"number"==sa(a)&&!isNaN(a)},sc=function(a){return Math.round(Number(a))||0},tc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},uc=function(a){var b=[];if(na(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},vc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},wc=function(a,b){if(!rc(a)||!rc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
